          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-primary mt-1">
                      {analyticsData.coursesStats.totalCourses}
                    </p>
                  </div>
              ...
              <Card>
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">Active Students</p>
              ...
              <Card>
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">Submissions</p>
                ...
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-orange-500 mt-1">
                      {analyticsData.submissionsStats.averageScore.toFixed(1)}/100
                    </p>
                  </div>
                    ...
                    <div className="h-80">
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          <Bar dataKey="submissions" name="Submissions" fill="#60a5fa" />
                          <Bar dataKey="completionRate" name="Completion Rate (%)" fill="#84cc16" />
                        </BarChart>
                      </ResponsiveContainer>
                    </div>
                  </CardContent>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center pb-4 border-b">
                          ...
                          <span>{analyticsData.coursesStats.publishedCourses}</span>
                        </div>
                        <div className="flex justify-between items-center pb-4 border-b">
                          <span className="font-medium">Total Modules:</span>
                          <span>{analyticsData.coursesStats.totalModules}</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="font-medium">Total Assignments:</span>
                          <span>{analyticsData.coursesStats.totalAssignments}</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie
                              data={analyticsData.enrollmentsStats.courseEnrollments}
                              cx="50%"
                              cy="50%"
                              labelLine={false}
                              ...
                              dataKey="count"
                            >
                              {analyticsData.enrollmentsStats.courseEnrollments.map((entry, index) => (
              ...
              <TabsContent value="students" className="space-y-6">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-8">
                      <h3 className="text-lg font-medium mb-4">Student Engagement by Course</h3>
                      <div className="space-y-2">
                        {analyticsData.enrollmentsStats.courseEnrollments.map((course, index) => (
                          <div key={index} className="space-y-1">
                            ...
                            <div className="w-full bg-neutral-200 h-2 rounded-full overflow-hidden dark:bg-neutral-700">
                              <div 
                                ...
                                style={{ 
                                  width: `${(course.count / Math.max(...analyticsData.enrollmentsStats.courseEnrollments.map(c => c.count))) * 100}%` 
                                }}
                              />
                            </div>
                          </div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="h-80">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart
                            data={analyticsData.submissionsStats.submissionsByMonth}
                          ...
                          >
                            ...
                            <YAxis />
                            <Tooltip />
                            <Bar dataKey="count" name="Submissions" fill="#2563eb" />
                          </BarChart>
                        </ResponsiveContainer>
                      </div>
                    </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-3 p-4 bg-neutral-50 rounded-lg dark:bg-neutral-800">
                        <h3 className="text-lg font-medium">Graded Submissions</h3>
                        <p className="text-3xl font-bold text-green-600">
                          {analyticsData.submissionsStats.gradedSubmissions}
                        </p>
                        <p className="text-sm text-neutral-500">
                          {analyticsData.submissionsStats.totalSubmissions > 0 
                            ? `${((analyticsData.submissionsStats.gradedSubmissions / analyticsData.submissionsStats.totalSubmissions) * 100).toFixed(1)}%`
                            : '0%'} of total
                        </p>
                      </div>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-neutral-600 dark:text-neutral-400">
                Start creating courses and assignments to generate analytics data.
              </p>
            </CardContent>
          </Card>
        )}
